                    ...
                    <div class="terms_section2">
                        <div class="terms">
                            <table class="list">
                                ...
                                <tr>
                                    <td class="lt_col0">История Науки и Техники</td>
                                </tr>

                                <tr>
                                    <td class="lt_col0">Политология</td>
                                </tr>

                                <tr>
                                    <td class="lt_col0">Информатика</td>
                                </tr>
